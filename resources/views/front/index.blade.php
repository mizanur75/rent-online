...
@section('title', 'Welcome to Rent Online')
            ...
            <div class="banner-content col-lg-4 col-md-6 header-right">
                ...
                <form method="POST" action="{{ route('login') }}" class="form">
                    ...
                    <div class="form-group">
                        <button class="btn btn-default btn-lg btn-block text-center text-uppercase">Login</button>
                    </div>
                </form>
            </div>
            <div class="col-lg-4  col-md-6 header-right">
                <h4 class="pb-30">Create an Account</h4>
                <form class="form">
                    <div class="from-group">
                        <input class="form-control txt-field inputfield" type="text" name="name" placeholder="Your name"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your name'">
                        ...
                        <input class="form-control txt-field inputfield" type="tel" name="phone" placeholder="Phone number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone number'">
                    </div>								
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="input-group dates-wrap">                                              
                            <input id="datepicker2" class="dates form-control inputfield"  placeholder="Date & time" type="text">                        
                    ...
                    <div class="form-group">
                            ...
                            <button class="btn btn-default btn-lg btn-block text-center text-uppercase">Create</button>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 about-right">
                <h1>Connected with Large Network</h1>
